...
import EndScreen from "@/pages/EndScreen/UI/EndScreen"
...
import GameAreaLearnMode from "@/pages/GameArea/UI/GameAreaLearnMode"
export const router = createBrowserRouter(
	createRoutesFromElements(
		<Route path="/" element={<GlobalWrapper />}>
			<Route path="/completed/:id" element={<EndScreen />}></Route>
			...
			<Route
				path="/tutorial/:id"
				element={<GameAreaLearnMode song={biggerThanEverythingYeat} />}
			></Route>
